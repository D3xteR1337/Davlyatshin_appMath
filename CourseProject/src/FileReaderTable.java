...
public class FileReaderTable {
    ...
    public static ArrayList<TableInfo> parseCSV() {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                arrayList.add(new TableInfo(line));
            }
    ...
    public static void downloadCSV(String from, String to) throws IOException {
        ...
        String urlString = "http://export.finam.ru/SBER_191114_191214.csv?market=520&em=484429&code=SBER&" +
                ...
                "&to=" + toArr[2] + "." + toArr[1] + "." + toArr[0] + "&p=8&f=SBER_" +
                (Integer.parseInt(fromArr[0]) - 2000) + fromArr[1] + fromArr[2] + "_" + (Integer.parseInt(toArr[0]) - 2000) + toArr[1] + toArr[2] +
                "&e=.csv&" +
                "cn=SBER&dtf=3&tmf=1&MSOR=1&mstime=on&mstimever=1&sep=3&sep2=1&datf=5&at=1";
